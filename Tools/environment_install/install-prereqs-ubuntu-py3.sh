...
SITL_PKGS="libtool libxml2-dev libxslt1-dev python-dev python3-pip python-setuptools python3-matplotlib python3-serial python3-scipy python3-opencv python3-numpy python3-pyparsing xterm lcov gcovr"
ASSUME_YES=false
QUIET=false
