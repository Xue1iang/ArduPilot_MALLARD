...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    case SUB_FRAME_DIAGONAL:
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     1,              0,              0,           0,                  0,              0,           1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,     0,              1,              0,          0,                  0,              0,          2);
        add_motor_raw_6dof(AP_MOTORS_MOT_3,     0,              0,              1,          0,                  0,               0,           3);
        add_motor_raw_6dof(AP_MOTORS_MOT_4,     0,              0,              0,           1,                  0,               0,          4);
        break;
